...
class VistaClienteController extends Controller
{
    public function index()
    {
        ...
        return view('vistaCliente.index',compact('lugares','clientes','vehiculos'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('index.vistaCliente')->with('success', 'Reservación creada con éxito.');
    }
...
\Log::info('Reservación encontrada:', ['reservacion' => $reservacion]);
    ...
    'redirect'=>route('index.vistaCliente')]
    , 200);
}
}
